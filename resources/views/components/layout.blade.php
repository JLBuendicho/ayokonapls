<!DOCTYPE html>
<html lang="en" data-theme="Birdy">

<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>{{ isset($title) ? $title . ' - Birdy' : 'Birdy' }}</title>
    ...
    <meta property="og:url" content="https://Birdy.laravel.cloud" />

    <!-- Favicons -->
    <link rel="icon" type="image/x-icon" href="{{ asset('favicon.ico') }}">
    <link rel="icon" type="image/svg+xml" href="{{ asset('arje.svg') }}">
...
<body class="min-h-screen flex flex-col
    ...
    <nav class="navbar bg-base-100">
        <div class="navbar-start">
            <a href="/"><svg xmlns="http://www.w3.org/2000/svg" alt="Birdy" fill="none" viewBox="0 0 312 69"
